...
class Exercicio_2 {
    public static void main(String[] args) {
         ...
         System.out.println("MULTIPLICACAO DAS MATRIZES:  ");
         
         for (int l = 0; l < 3; l++) {
           
             for(int c = 0; c < 2; c++) {
           
                media[l][c] = (matriz_a[l][c] * matriz_b[l][c] * matriz_c[l][c]);
                
                         System.out.println("A MULTIPLICACAO DA LINHA " + l + " E DA COLUNA " + c + " CORRESPONDE A " + media[l][c]);
